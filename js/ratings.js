function drawRatings() {
  ...
  /*  let svg = d3.select("body").select("svg#raitings")
  ...
  d3.json("data_movie/combined/jsondata.json").then(drawHierarchy);
  d3.csv("data_movie/combined/movie_metadata_edited.csv").then(drawSimpleChart);
  ...
  function drawSimpleChart(data) {
    ...
    const g = svg.append("g")
      .attr("id", "plot")
      .attr("transform", translate(pad + 220, pad + 110));
